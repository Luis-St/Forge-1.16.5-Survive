...
public class BackpackNextDownToolMessage {

	
	public static void encode(BackpackNextDownToolMessage message, PacketBuffer buffer) {
		
	}

	
	public static BackpackNextDownToolMessage decode(PacketBuffer buffer) {
		
		return new BackpackNextDownToolMessage();
		
	}

	
	public static void handle(BackpackNextDownToolMessage message, Supplier<Context> networkContext) {
