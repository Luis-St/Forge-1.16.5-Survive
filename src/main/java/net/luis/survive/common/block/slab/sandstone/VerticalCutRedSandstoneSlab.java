...
public class VerticalCutRedSandstoneSlab extends AbstractVerticalSlab {
	
	public VerticalCutRedSandstoneSlab() {

		super(AbstractBlock.Properties.from(Blocks.CUT_RED_SANDSTONE_SLAB));
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
		...
		if (hit.getFace().getOpposite() == state.get(VerticalCutRedSandstoneSlab.FACING)
				...
				&& player.getHeldItem(handIn).getItem() == ModVerticalBlockItems.VERTICAL_CUT_RED_SANDSTONE_SLAB_ITEM.get()) {
