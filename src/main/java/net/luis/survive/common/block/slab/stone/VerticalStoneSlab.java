...
public class VerticalStoneSlab extends AbstractVerticalSlab {
	
	public VerticalStoneSlab() {

		super(AbstractBlock.Properties.from(Blocks.STONE_SLAB));
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
		...
		if (hit.getFace().getOpposite() == state.get(VerticalStoneSlab.FACING)
				...
				&& player.getHeldItem(handIn).getItem() == ModVerticalBlockItems.VERTICAL_STONE_SLAB_ITEM.get()) {
